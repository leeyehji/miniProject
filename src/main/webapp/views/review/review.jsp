...
<body>
	...
	<div id="frameContent">
		...
		<div id="content">
			...
			<div id="reviewMain" class="reviewMain">
				...
				<div id="backList">
					<a href="../../views/review/reviewList.jsp">여행 게시판> </a>
				</div>

				<div id="reviewItem" style="background-color: white;">

					<div style="text-align: center;">
						<h1 id="reviewTitle">여행 후기 게시판 제작</h1>
					</div>
					...
					<div id="reviewInfo">
						...
						<p>
							작성자 : <span id="userId">name</span>
						</p>
						<p>
							작성일 : <span id="date">date</span>
						</p>
						<p>
							조회수 : <span id="hit">hit</span>
						</p>
					...
					<div id="reviewContent">
						...
						<p>
							<img
								src="../../resources/review/image/KakaoTalk_Photo_2024-02-28-21-46-05%20006.jpeg"
							...
							있다고 할 수 있다.  <img
								src="../../resources/review/image/KakaoTalk_Photo_2024-02-28-21-46-05%20011.jpeg"
								alt="이미지"> 의존한다는 것은 의존대상, 여기서는 Service가 변하면 그것이 Controller
							에게로 전달된다는 뜻이다.만약 Service의 test()메소드가 변경되면 Controller에서도 그에 따른 수정이
							필요하게 되거나 형식은 그대로지만 로직이 변경되면 결과적으로  Controller의 기능에도 영향을 미친다. 이와같이
							두 객체간의 관계를 맺어주는 것을 의존성 주입이라고 하며 스프링에서는 3가지 방법의 의존성 주입방법이 있다. 출처:
				...
				<div id="reviewComment" style="background-color: white;">
					...
					<div id="commentConsole" >
						<table id="commentTable" >
							<tr>
								<td rowspan="4" id="imgTd"> <img src="" alt="이미지"> </td>
							</tr>
							<tr >
							   <td colspan="2">작성자 :<span id="commentUserId"> USERID</span>
							   </td>
							 
							</tr>
							<tr>
								<td colspan="2">
									<span id="commentContent">작성내용</span>
								</td>
							</tr>
							<tr >
								<td colspan="2" >
									<span id="commentDate">작성일</span>
								</td>
							</tr>
							<tr id="commentTr">
	...
	<script src="../../resources/review/js/review.js"></script>
