...
<div id="mypageContent">
	<div id="profile_userIntro">
		...
		<div id="userIntro">
			<div id="userIntroContent">
				...
				<div class="btnRight">
					<input type="button" onclick="location.href='memberUpdate.jsp'" value="회원정보 수정" class="mypageChangeBtn">
				</div>
			</div>
		</div>
	...
	<div id="boxes">
		<div class="contentBox" id="contentBox1">
			...
			<div class="btnRight">
				<input type="button" onclick="location.href='../mypage/myBoard.jsp'" value="대표글 변경" class="mypageChangeBtn">
			</div>
		</div>
		...
		<div class="contentBox">
			<div class="boxContent">
				<div id="box2Content">
					...
					<div class="btnRight">
						<input type="button" onclick="location.href='../mypage/memberCalendar.jsp'" value="캘린더 수정" class="mypageChangeBtn">
					</div>
				</div>
			</div>
		</div>
