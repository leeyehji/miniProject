...
<link rel="stylesheet" type="text/css" href="../../resources/detail/css/detailPage.css">
...
<body>
		...
		<div id="content">
			...
			<div id="detailWrap">
				<div id="detailBody">
					...
					<div id="detailMain">
						<div id="detailImg">
							<img src="../../resources/detail/image/경복궁.jpg" alt="경복궁">
						</div>
						<div>
							<h3>상세정보</h3>
							<hr>
					...
					<div id="datailInfo">
						<table style="font-size: 11pt; margin: 0 auto;">
							...
							<td colspan="4" id="icon">
								<img src="../../resources/detail/icon/pet.png" id="pet" class="noAllow"/>
								<img src="../../resources/detail/icon/stoller.png" id="stoller" class="noAllow"/>
								<img src="../../resources/detail/icon/parking.png" id="parking" class="noAllow"/>
								<img src="../../resources/detail/icon/wheelchair.png" id="wheelchair" class="noAllow"/>
								<img src="../../resources/detail/icon/disabled.png" id="disabled" class="noAllow"/>
							</td>
							</tr>
						</table>
					</div>
	...
	<script src="../../resources/detail/js/detailPage.js"></script>
	<script>
